<template>
    <div class="container px-5 py-5 mx-auto">
        <div class="text-center pb-4">
            <form class="flex flex-wrap gap-5 justify-center items-center" @submit="serchPost">
                <div class="col-auto my-2">
                    <input type="text" v-model="search" @input="textsearch"
                        class="form-control post-input p-1 rounded-md" id="inputPassword2"
                ...
                <div class="col-auto my-2">
                    <select v-model="selectedCategory" @change="applyFilter"
                        class="form-select post-input p-1 rounded-md" :disabled="isCategoryDisabled">
                ...
                <div class="col-auto my-2" v-if="selectedCategory">
                    <select v-model="selectedSubCategory" @change="applyFilter"
                        class="form-select post-input p-1 rounded-md">
                        <option disabled value="">Filter By Subcategory</option>
                        <option v-for="subCategory in subCategories[selectedCategory]" :key="subCategory"
                            :value="subCategory">
                            {{ subCategory }}
                        </option>
                    </select>
                ...
                <div class="col-auto my-2 ">
                    <a href="" class="btn-clear p-2 px-4 rounded-md shadow-md"
                        @click="clearFilter"><b>Clear</b></a>
                </div>
        ...
        <div class="flex flex-wrap m-4" v-if="filteredPosts">
            <ArticleCard v-for="article in filteredPosts" :key="article._id" :article="article" />
        </div>
        <!-- <div class="flex flex-wrap m-4" v-if="filteredPosts">
      <div
